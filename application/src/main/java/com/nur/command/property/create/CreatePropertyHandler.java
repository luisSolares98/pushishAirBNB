...
@Component
public class CreatePropertyHandler implements Command.Handler<CreatePropertyCommand, PropertyDto> {
	...
	public CreatePropertyHandler(PropertyRepository propertyRepository
	...
	public PropertyDto handle(CreatePropertyCommand request) {
		try {
			Property property = propertyFactory.create(request.propertyDto.getName(), request.propertyDto.getAmount(),
					request.propertyDto.getDescription(), request.propertyDto.getState(),
