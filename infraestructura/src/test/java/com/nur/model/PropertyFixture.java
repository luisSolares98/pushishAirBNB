...
public class PropertyFixture {
	...
	public static List<PropertyJpaModel> whitDefaultListJPA() throws BussinessRuleValidationException, ParseException {
		return Arrays.asList(new PropertyJpaModel(UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c20"), "test",
				"test description", 10.0, "disponible", UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c10")),
				new PropertyJpaModel(UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c21"), "test",
						"test description", 11.0, "disponible",
						UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c10")));
	}
