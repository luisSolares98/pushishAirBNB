...
public class CharacteristicFixture {
    ...
    public static List<Characteristic> whitDefaultList() throws BussinessRuleValidationException, ParseException {
        return Arrays.asList(
                new Characteristic(UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c27"), "AGUA"),
    ...
    public static List<CharacteristicJpaModel> whitDefaultListJPA() throws BussinessRuleValidationException, ParseException {
        return Arrays.asList(new CharacteristicJpaModel(UUID.fromString("effa368e-2f33-49c7-94e4-a4dfb3be2c27"), "AGUA"),
